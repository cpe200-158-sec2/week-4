...
Answer: มีส่วนของ properties คือ width และ hight ของ Rectangle กับ Triangle ที่ยังซ้ำซ้อนกันอยู่
2. Modify the project so that you can minimize or solve those redundancy.
Answer:ย้าย width และ hight ไปไว้ใน class sharp
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
Answer:โปรแกรมจะ error เนื่องจากมีการสั่งให้สร้าง object จาก class sharp ซึ่งเป็น abstract class ที่ไม่สามารถสั่งให้สร้าง object เพิ่มได้
