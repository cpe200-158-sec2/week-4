...
its have in rectangle cass and triangle class in high part and wide part.
2. Modify the project so that you can minimize or solve those redundancy.
colors is in shape part.
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
the program doesnt work because of Shape.cs.the reason is no Constructors for build the new shape.
