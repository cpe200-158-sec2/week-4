...
ANS: มี คือตรงประกาศตัวแปร ความสูงและความกว้าง ของ triangle และ rectangle
2. Modify the project so that you can minimize or solve those redundancy.
ANS: ย้ายส่วนประกาศตัวแปรไปไว้ที่ shape class
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
ANS: โปรแกรม error เพราะว่าไม่สามารถประกาศสร้างตัวแปร abstract class ได้เนื่องจาก abstract class นั้นไม่ใช่คลาสที่สมบูรณ์
