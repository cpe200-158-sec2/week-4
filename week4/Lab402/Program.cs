...
namespace Lab402
{
	class MainClass
	{
		...
		{
			Shape s1 = new Rectangle("red", 4, 5); 			Console.WriteLine (s1);  			Shape s2 = new Triangle("blue", 4, 5); 			Console.WriteLine (s2);  			Shape s3 = new Rectangle(); 			Console.WriteLine (s3);  			Rectangle r1 = new Rectangle((Rectangle)s1); 			Console.WriteLine (r1); 			r1.width=-5.0; r1.hight=15; 			Console.WriteLine (r1);  			Triangle t1 = new Triangle(); 			t1.width=3; t1.hight=4; 			Console.WriteLine (t1);
