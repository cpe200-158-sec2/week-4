...
namespace Lab4
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			Console.WriteLine ("Perimeter of s1: " + printPerimeter(s2));
			Console.WriteLine ("Perimeter of s1: " + printPerimeter(s3));
			Console.WriteLine ("Perimeter of s1: " + printPerimeter(r1));
			Console.WriteLine ("Perimeter of s1: " + printPerimeter(t1));
