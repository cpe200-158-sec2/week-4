...
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
	รันไม่ผ่าน เพราะ getPerimeter เป็น Abstract Class นำไปใช้งานเลยไม่ได้ 
	ต้องมีการเรียกใช้ printPerimeter ใน Program.cs ซึ่งจะ Return ค่า getPerimeter มาเป็นคำตอบ
